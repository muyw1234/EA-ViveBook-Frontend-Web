...
export default function Retos() {
    ...
    const getIcon = (type: string) => {
        switch (type) {
            case "COMPRAR_LIBROS": return "🛒";
            case "ALQUILAR_LIBROS": return "📖";
            case "SEGUIR_USUARIOS": return "👥";
            case "RECIBIR_VALORACIONES": return "⭐";
            case "ASISTIR_EVENTOS": return "🎫";
            case "SUBIR_LIBROS": return "📤";
            default: return "🏆";
        }
    };
    ...
    const getBadgeColor = (type: string) => {
        switch (type) {
            case "COMPRAR_LIBROS": return "#FFE2E2";
            case "ALQUILAR_LIBROS": return "#E2F0FF";
            case "SEGUIR_USUARIOS": return "#EAFEEA";
            case "RECIBIR_VALORACIONES": return "#FFF7E2";
            case "ASISTIR_EVENTOS": return "#F0E2FF";
            case "SUBIR_LIBROS": return "#E2FFE2";
                ...
                <div className="level-badge-container">
                    ...
                    <div className="level-info-text">
                        ...
                        <p className="level-description">
                            {userLevel.levelName === "Oro" && "¡Felicidades! Has completado todos los retos disponibles. ¡Eres un lector legendario! 🌟"}
                            {userLevel.levelName === "Plata" && "¡Buen trabajo! Has completado al menos la mitad de los retos. ¡Sigue así! 🚀"}
                            {userLevel.levelName === "Bronce" && "¡Vas por buen camino! Has completado al menos 3 retos. ¡Pronto subirás al siguiente nivel! 🌱"}
                            {userLevel.levelName === "Sin nivel" && "Completa retos para desbloquear tu primera medalla. ¡Comienza hoy! 📖"}
                        </p>
                    </div>
                </div>
            </div>
                                                ...
                                                >
                                                    <div className="reto-item-top-row">
                                                        <div className="reto-text-col">
                                                            ...
                                                            {reto.description && (
                                                                <span className="reto-item-description">
                                                                    {reto.description}
                                                                </span>
                                                            )}
                                                        </div>
