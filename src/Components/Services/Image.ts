...
async function upload(data:FormData) : Promise<string | undefined> {
    ...
    try {
        const res = await (await axios.post(`https://api.cloudinary.com/v1_1/df2qxcelv/image/upload`, data, { // tambien tendria que extraer el cloudname en variables de entornos ...
            headers: {
