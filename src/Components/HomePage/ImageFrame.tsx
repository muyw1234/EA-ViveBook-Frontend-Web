...
export default function ImageFrame(props: { imageUrl: string | undefined }) {
  if (props.imageUrl) return <img src={props.imageUrl} height="255px" width="512px"></img>;
  else return <span className="placeholder-text">Imagen no disponible</span>; //Tambien podria ser un icono de imagen no encontrado
}
